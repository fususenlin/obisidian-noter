...
Link to my plugin: https://github.com/fususenlin/obisidian-noter
...
Noter is a Flomo-style quick note plugin that provides:
- Fast note input with tag support (#tags)
- Tag cloud and filtering
- Review mode for revisiting past notes
